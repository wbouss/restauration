<?php /* Smarty version Smarty-3.1.19, created on 2017-06-09 20:54:52
         compiled from "/htdocs/prestashop/themes/default-bootstrap/addresses.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2114197642593aeefcdffcc7-04155688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '858e1071db809ff09a4c947e19087d153cc2faab' => 
    array (
      0 => '/htdocs/prestashop/themes/default-bootstrap/addresses.tpl',
      1 => 1497033067,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2114197642593aeefcdffcc7-04155688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_593aeefcf25676_51328103',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_593aeefcf25676_51328103')) {function content_593aeefcf25676_51328103($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/htdocs/prestashop/tools/smarty/plugins/modifier.replace.php';
?>
...
<?php $_tmp40=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp40), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
                <a class="btn btn-default button button-small" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['address']->value['object']['id']);?>
<?php $_tmp41=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"id_address=".$_tmp41."&delete"), ENT_QUOTES, 'UTF-8', true);?>
