<?php /* Smarty version Smarty-3.1.19, created on 2017-06-09 20:54:55
         compiled from "/htdocs/prestashop/themes/default-bootstrap/order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1356553844593aeeff55add8-39141484%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85751deaac06619ae55a0e3c03cddd684c27b812' => 
    array (
      0 => '/htdocs/prestashop/themes/default-bootstrap/order-address-multishipping.tpl',
      1 => 1497033072,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1356553844593aeeff55add8-39141484',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_593aeeff6902a1_74957776',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_593aeeff6902a1_74957776')) {function content_593aeeff6902a1_74957776($_smarty_tpl) {?>
...
<?php $_tmp44=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp45=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp44.$_tmp45), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp46=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp47=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp46.$_tmp47), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
	</p>
